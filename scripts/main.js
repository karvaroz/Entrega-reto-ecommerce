async function fetchData() {
  fetch("/data/data.json")
    ...
    .then((data) => {
      console.log(data);
      let output = document.querySelector(".box-product");
      data.clothing.forEach((card) => {
        let { id, name, price, description, type, image, category } = card;
        output.innerHTML += `
        <div class="col d-flex justify-content-center mb-4">
          <div class="card shadow mb-1 bg-light rounded" style="width: 20rem">
            ...
            <div class="card-body">
              ...
              <h5 class="text-dark">
                Precio: <span class="precio">$ ${price}</span>
              </h5>
